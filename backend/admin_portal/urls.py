...
from admin_portal.views import (
    ...
    AdminOrganizationReviewActionView,
    ...
    AdminSiteDocumentDetailView,
    AdminSiteDocumentsView,
...
urlpatterns = [
    ...
    path("organizations", AdminOrganizationsView.as_view(), name="admin_organizations"),
    path("organizations/<int:organization_id>", AdminOrganizationDetailView.as_view(), name="admin_organization_detail"),
    path("organizations/<int:organization_id>/review/<str:action>", AdminOrganizationReviewActionView.as_view(), name="admin_organization_review_action"),
    ...
    path("site-documents", AdminSiteDocumentsView.as_view(), name="admin_site_documents"),
    path("site-documents/<str:doc_type>", AdminSiteDocumentDetailView.as_view(), name="admin_site_document_detail"),
    ...
    path("ai/rewrite", AdminAiRewriteView.as_view(), name="admin_ai_rewrite"),
    path("llm-providers", AdminLLMProvidersView.as_view(), name="admin_llm_providers"),
    path("llm-providers/<str:provider>", AdminLLMProviderDetailView.as_view(), name="admin_llm_provider_detail"),
    path("llm-providers/<str:provider>/activate", AdminLLMProviderActivateView.as_view(), name="admin_llm_provider_activate"),
    path("uploads/<str:asset_type>", AdminAssetUploadView.as_view(), name="admin_asset_upload"),
]
